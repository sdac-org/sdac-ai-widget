    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end pointer-events-none">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-[380px] h-[580px] bg-white rounded-2xl shadow-2xl border border-slate-200 flex flex-col overflow-hidden mb-4"
          >
            {/* Header */}
      ...
      {!isOpen && (
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={handleOpen}
          className="pointer-events-auto w-[60px] h-[60px] bg-slate-900 rounded-full shadow-xl shadow-slate-900/20 flex items-center justify-center relative group z-50"
        >
          ...
          <div className="absolute right-full mr-4 bg-slate-800 text-white text-xs px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
            SDAC Assistant
          </div>
        </motion.button>
      )}
